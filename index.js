    ...
    try {
        ...
        if (formInputs.length > 0) {
            ...
            if (formInputs[0]) {
                ...
                const value = await formInputs[0].evaluate(el => el.value);
                console.log('Student ID field value:', value);
            }
            ...
            if (formInputs[1]) {
                ...
                const value = await formInputs[1].evaluate(el => el.value);
                console.log('Last Name field value:', value);
            }
            ...
            if (formInputs[2]) {
                ...
                const value = await formInputs[2].evaluate(el => el.value);
                console.log('First Name field value:', value);
            }
            ...
            if (formInputs[3]) {
                ...
                const value = await formInputs[3].evaluate(el => el.value);
                console.log('Middle Initial field value:', value);
            }
        ...
        try {
            ...
            if (dropdowns.length > 0) {
                ...
                // Try different combinations to find PRESENT
